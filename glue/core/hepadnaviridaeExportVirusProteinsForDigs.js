...
glue.command(["file-util", "save-string", core_fasta_aa_str, "export/core.faa"]);

var pol_fasta_aa_str = pol_fasta_aa.join("\n");
glue.command(["file-util", "save-string", pol_fasta_aa_str, "export/pol.faa"]);

var surface_fasta_str = surface_fasta_aa.join("\n");
glue.command(["file-util", "save-string", surface_fasta_aa, "export/surface.faa"]);
...
function process_feature(featureSummary, refseqID, featureID) {
	...
	if (featureID == "PreCore-Core" || featureID == "Polymerase" || featureID == "large-S" ) {
...
function create_feature_fasta(refseqID, featureID, featureCodons, featureSummary) {
	...
	if (featureID == "large-S") {
	
	  surface_fasta_aa.push(fasta_aa); 
	}	
