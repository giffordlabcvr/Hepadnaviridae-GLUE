...
This **Hepadnavirus-GLUE**  project can be extended with an additional layer: **[Hepadnaviridae-GLUE-EVE](https://github.com/giffordlabcvr/Hepadnavirus-GLUE-EVE)**. This extension layer, which is also openly available via GitHub, extends Hepadnavirus-GLUE through the incorporation of **endogenous hepadnaviral elements**.
